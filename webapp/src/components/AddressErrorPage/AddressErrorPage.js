...
export default class AddressErrorPage extends React.PureComponent {
  render() {
    return (
      <StaticPage>
        <h2>
        ...
        <div className="message">
          <p>
            We couldn&#39;t retrieve any account information associated with
            your current address. Are you using the correct address?
          </p>
          <br />
          <p>
