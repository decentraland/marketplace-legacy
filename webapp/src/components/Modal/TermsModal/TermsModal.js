        ...
        <div className="modal-body">
          <div className="text">
            ...
            <p>
              ...
              result of your ownership, or transfer of any parcel).
            </p>
            ...
            <h4>17.5 Right to Opt Out</h4>
            <p>
              You have the right to opt-out and not be bound by the arbitration
              and class action waiver provisions set forth above by
              discontinuing your access to and use of the Service.
            </p>
